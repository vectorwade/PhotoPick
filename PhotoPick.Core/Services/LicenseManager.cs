...

{
...

    {
        ...
        // 4. Cálculo do Período Trial (15 dias corridos)
...

        {
            ...
            result.StatusMessage = "Período de teste de 15 dias encerrado.";
...

        {
            ...
            result.DaysRemaining = (int)Math.Max(1, Math.Ceiling(15.0 - elapsedDays));
