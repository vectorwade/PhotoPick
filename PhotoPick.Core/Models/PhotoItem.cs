...
public class PhotoItem : INotifyPropertyChanged
{
    ...
    public int? FocalLength35mm
    {
        ...
        set { if (_focalLength35mm != value) { _focalLength35mm = value; OnPropertyChanged(); } }
    }

    public double? MaxAperture
    {
        get => _maxAperture;
        set { if (_maxAperture != value) { _maxAperture = value; OnPropertyChanged(); } }
    }

    public string? MeteringMode
    {
        get => _meteringMode;
        set { if (_meteringMode != value) { _meteringMode = value; OnPropertyChanged(); } }
    }

    public string? ExposureProgram
    {
        get => _exposureProgram;
        set { if (_exposureProgram != value) { _exposureProgram = value; OnPropertyChanged(); } }
    }

    public string? ExposureMode
    {
        get => _exposureMode;
        set { if (_exposureMode != value) { _exposureMode = value; OnPropertyChanged(); } }
    }

    public string? WhiteBalance
    {
        get => _whiteBalance;
        set { if (_whiteBalance != value) { _whiteBalance = value; OnPropertyChanged(); } }
    }

    public string? Software
    {
        get => _software;
        set { if (_software != value) { _software = value; OnPropertyChanged(); } }
    }
